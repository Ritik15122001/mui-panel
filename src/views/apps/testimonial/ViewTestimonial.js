...
const ViewTestimonial = () => {
  ...
  const handleUpdate = (row) => {
    navigate('/apps/testimonial/update', { state: { row } });
  };
  const handlePreview = (row) => {
    navigate('/apps/testimonial/preview', { state: { row } });
  };
  ...
  return (
    <PageContainer title="Testimonial">
      {/* breadcrumb */}
                  ...
                  <TableRow key={row.key}>
                    ...
                    <TableCell>
                      <Stack direction="row" spacing={2} alignItems="center">
                        <Avatar
                          src={row.reviewerImage.url}
                          alt={row.reviewerImage.name}
                          width="30"
                        />
                      </Stack>
                    </TableCell>
